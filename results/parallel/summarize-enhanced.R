...
variance <- reshape2::melt(df2, id.vars=id.vars, value.vars=c("adj_true_var", "adj_est_var", "eadj_true_var", "eadj_est_var"), variable.name="estimator", value.name="variance") %>% data.table
