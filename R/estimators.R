...
#' @param mu_var Variance of the estimator for mean window period. If \eqn{\mu} is known, input 0.
#' @param n_p_test Optional number of positives that were given a recency test. If left \code{NULL},
...
estSnapshot <- function(n_r, n_n, n_p, n, mu, mu_var, n_p_test=NULL){
